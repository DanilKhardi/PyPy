...
# =======================================================================================
# OOP Style refactoring code
# =======================================================================================


class Vec2d():
    def __init__(self, x_coord_pair, y_cord_pair = None):
        if y_cord_pair is None:
            self.x = x_coord_pair[0]
            self.y = x_coord_pair[1]
        else:
            self.x = x_coord_pair
            self.y = y_cord_pair
